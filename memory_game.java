...
public class Memory {
   ...
   {
	   printBoard(board);
	   int firstIndex=getCardIndex(sc,board,flipped,"Enter index of first card to flip:");
	   board[firstIndex]=cards.get(firstIndex);
	   flipped[firstIndex]=true;
	   printBoard(board);
	   int secondIndex=getCardIndex(sc,board,flipped,"Enter index of second card to flip:");
